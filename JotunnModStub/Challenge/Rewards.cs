...
namespace ValheimFortress.Challenge
{
    static class Rewards
    {
        ...
        public static Dictionary<String, RewardEntry> resourceRewards = new Dictionary<string, RewardEntry>
        {
            ...
            { "Tin", new RewardEntry(resource_prefab: "TinOre", resouce_cost: 30, required_boss: "TheElder", enabled: true)},
            { "Iron", new RewardEntry(resource_prefab: "IronScrap", resouce_cost: 40, required_boss: "BoneMass", enabled: true)},
            { "Silver", new RewardEntry(resource_prefab: "SilverOre", resouce_cost: 50, required_boss: "Moder", enabled: true)},
            { "Darkmetal", new RewardEntry(resource_prefab: "BlackMetalScrap", resouce_cost: 60, required_boss: "Yagluth", enabled: true)},
            { "Tar", new RewardEntry(resource_prefab: "Tar", resouce_cost: 20, required_boss: "Yagluth", enabled: true)},
            { "Guck", new RewardEntry(resource_prefab: "Guck", resouce_cost: 20, required_boss: "BoneMass", enabled: false)},
            { "Sap", new RewardEntry(resource_prefab: "Sap", resouce_cost: 25, required_boss: "TheQueen", enabled: true)},
            { "SoftTissue", new RewardEntry(resource_prefab: "Softtissue", resouce_cost: 70, required_boss: "TheQueen", enabled: true)},
