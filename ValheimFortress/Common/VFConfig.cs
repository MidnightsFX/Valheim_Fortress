...
namespace ValheimFortress
{
    class VFConfig
    {
        ...
        public static ConfigEntry<short> BaseChallengePoints;
        public static ConfigEntry<short> MaxChallengePoints;
        public static ConfigEntry<float> ChallengeSlope;
        public static ConfigEntry<float> ChanceOfPreviousBiomeCreature;
        public static ConfigEntry<short> MaxCreatureStars;
...
#     percent: 30            |- This is the percentage of the waves total point pool that will be used for this spawn";
                    writetext.WriteLine(header);
                    writetext.WriteLine(WaveStyles.YamlWaveDefinition());
                }
            }
...
#   uniqueSpawnModifiers: ";
                    writetext.WriteLine(header);
                    writetext.WriteLine(ChallengeLevels.YamlLevelsDefinition());
                }
            }
...
#                             fit higher difficulty waves. eg: a greydwarf spawning into a swamp level wave will recieve 1 bonus star, since it is from the black forest, which is 1 biome behind the swamp.";
                    writetext.WriteLine(header);
                    writetext.WriteLine(Monsters.YamlCreatureDefinition());
                }
            }
...
";
            ...
            try
            {
                ...
                WaveStyles.UpdateWaveDefinition(waveStyleValues);
            }
            ...
            try
            {
                ...
                Monsters.UpdateSpawnableCreatures(creatureValues);
            ...
            try
            {
                ...
                ChallengeLevels.UpdateLevelsDefinition(levelsValues);
            }
        ...
        private static bool UpdateLevelsInMemory(string raw_levels_data)
        {
            ...
            ChallengeLevels.UpdateLevelsDefinition(levelsDefinitionConfigValues);
            return true;
        }
        ...
        private void CreateConfigValues(ConfigFile Config)
        {
            ...
            // Difficulty Scaling
            BaseChallengePoints = BindServerConfig("Difficulty Levels", "BaseChallengePoints", 100, "The base number of points that all waves add. This is especially impactful in early levels (meadows).", false, 100, 1000);
            MaxChallengePoints = BindServerConfig("Difficulty Levels", "MaxChallengePoints", 3000, "The absolute max number of points a wave can generate with, higher values will be clamped down to this value.", true, 1000, 30000);
            ...
            ArenaShrineMaxCreaturesPerWave = BindServerConfig("Shrine of Arena", "ArenaShrineMaxCreaturesPerWave", (short)25, "The max number of creatures that a wave can generate with, creatures will attempt to upgrade and reduce counts based on this.", true, 12, 200);
