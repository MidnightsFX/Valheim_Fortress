...
namespace ValheimFortress.Challenge
{
    internal static class RewardsData
    {
        ...
        public static Dictionary<String, RewardEntry> resourceRewards = new Dictionary<string, RewardEntry>
        {
            ...
            { ValheimFortress.LocalizeOrDefault("$reward_copper", "Copper"), new RewardEntry { resourcePrefab = "CopperOre", resouceCost = 45, requiredBoss = ELDER, enabled = true, rewardMinLevelIndex = 5}},
            { ValheimFortress.LocalizeOrDefault("$reward_tin", "Tin"), new RewardEntry { resourcePrefab = "TinOre", resouceCost = 40, requiredBoss = ELDER, enabled = true, rewardMinLevelIndex = 5 }},
            { ValheimFortress.LocalizeOrDefault("$reward_iron", "Iron"), new RewardEntry { resourcePrefab = "IronScrap", resouceCost = 60, requiredBoss = BONEMASS, enabled = true, rewardMinLevelIndex = 10}},
            { ValheimFortress.LocalizeOrDefault("$reward_silver", "Silver"), new RewardEntry { resourcePrefab = "SilverOre", resouceCost = 70, requiredBoss = MODER, enabled = true, rewardMinLevelIndex = 15}},
            { ValheimFortress.LocalizeOrDefault("$reward_blackmetal", "Darkmetal"), new RewardEntry { resourcePrefab = "BlackMetalScrap", resouceCost = 80, requiredBoss = YAGLUTH, enabled = true, rewardMinLevelIndex = 20}},
            { ValheimFortress.LocalizeOrDefault("$reward_flametal", "Flametal"), new RewardEntry { resourcePrefab = "FlametalNew", resouceCost = 160, requiredBoss = FADER, enabled = true, rewardMinLevelIndex = 30}},
            ...
            { ValheimFortress.LocalizeOrDefault("$reward_guck", "Guck"), new RewardEntry { resourcePrefab = "Guck", resouceCost = 40, requiredBoss = BONEMASS, enabled = false, rewardMaxLevelIndex = 30}},
            { ValheimFortress.LocalizeOrDefault("$reward_sap", "Sap"), new RewardEntry { resourcePrefab = "Sap", resouceCost = 100, requiredBoss = QUEEN, enabled = true, rewardMinLevelIndex = 25}},
            { ValheimFortress.LocalizeOrDefault("$reward_softtissue", "SoftTissue"), new RewardEntry { resourcePrefab = "Softtissue", resouceCost = 140, requiredBoss = QUEEN, enabled = true, rewardMinLevelIndex = 25}},
        };
